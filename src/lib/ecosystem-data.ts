...
export const SECTORS: Sector[] = [
  ...
  {
    id: "expression",
    label: "Expression Cortex",
    sublabel: "Voice · Display",
    startAngle: 36,
    endAngle: 108,
...
export const NODES: EcoNode[] = [
  // Brain (center)
  {
    ...
    layer: "intel",
    description:
      "The AI orchestrator at the heart of the ecosystem. Fuses signals from every layer and triggers responses.",
  ...
  // NEW — LAN (wired synapse)
  {
    ...
    layer: "connect",
    description:
      "On-site wired LAN backbone — the wired synapse that pairs with Private LTE for full redundancy.",
    features: [
      "10/25/100 GbE",
      "Dual-home redundancy",
  ...
  // NEW — Local HCI zone (inner cocoon)
  {
    ...
    layer: "local",
    description:
      "Hyper-converged local environment — internal DNS and locally-issued HTTPS certificates create a fully self-contained, offline-capable secure zone around the brain.",
